...
API Header Exception

In addition, as a special exception, the authors give You the additional right to use the API headers provided with this Program (the "API Headers") in other software, including software licensed under terms other than the GNU General Public License, without causing such software to be covered by the GNU General Public License.

This permission applies only to the API Headers and does not apply to the implementation of the Program or any other portion of the Program. Any modifications made to the API Headers themselves remain subject to the GNU General Public License unless separately permitted by the authors.
