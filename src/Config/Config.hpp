...
namespace GTS {
    ...
    public:
        ...
        static inline SettingsGeneral General = {};
        static inline SettingsAdvanced Advanced = {};
        static inline SettingsAI AI = {};
        static inline SettingsAudio Audio = {};
        static inline SettingsBalance Balance = {};
        static inline SettingsCamera Camera = {};
        static inline SettingsGameplay Gameplay{};
        static inline SettingsUI UI = {};
        static inline SettingsHidden Hidden = {};
