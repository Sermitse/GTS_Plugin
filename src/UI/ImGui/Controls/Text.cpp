...
namespace ImGuiEx {
    ...
    void TextShadowImplEx(ImVec2 a_pos, const char* a_text, const char* a_textEnd, ImU32 a_textColor, ImU32 a_shadowColor, float a_shadowOffset) {
        ...
        // Draw shadow text
        draw_list->AddText(ImVec2(a_pos.x + a_shadowOffset, a_pos.y + a_shadowOffset), a_shadowColor, a_text, a_textEnd);
        // Draw main text
        draw_list->AddText(a_pos, a_textColor, a_text, a_textEnd);
