...
namespace TrainWreckAPI {

    inline auto log_indent(void* context) -> std::optional<::trainwreck_error> {
    ...
    inline auto log_dedent(void* context) -> std::optional<::trainwreck_error> {
        const auto handle = ::GetModuleHandleW(L"trainwreck.dll");
        if (handle != NULL) {
    ...
    inline auto log_write_line(void* context, std::string_view line)
    ...
    inline auto register_section(::trainwreck_section_where register_where,
    ...
    inline auto register_decoder(std::string_view decorated_name,
    ...
    class Log {
        ...
        public:
        Log(void* log_context) {
            this->m_log_context = log_context;
        }

        auto indent() const -> std::optional<::trainwreck_error> {
            return TrainWreckAPI::log_indent(this->m_log_context);
        }

        auto dedent() const -> std::optional<::trainwreck_error> {
            return TrainWreckAPI::log_dedent(this->m_log_context);
        }

        auto with_indent(std::function<void(TrainWreckAPI::Log&)> callback)
            -> std::optional<::trainwreck_error> {
        ...
        auto write_line(std::string_view line) const -> std::optional<::trainwreck_error> {
            return TrainWreckAPI::log_write_line(this->m_log_context, line);
        }
